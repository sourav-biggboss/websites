<?php
//website mail name
$web_setFrom = "Your GEM Registration On Hold";
//subject of otp mail
$web_Subject = 'Hury Up ! GEM Registration Will Expire Soon';
//body of otp mail
$web_Body =
    '
    ...
    <center><img src="https://gemregistrar.com/assets/img/image-hurry.jpg" width="150px" /></center>
    <div id="container" style="border:2px solid #ddd; padding: 20px ;  margin: 10px 0px 20px 0px;font-weight:600;">
      <div>
        ...
        <br><br>
        <div style="color:#b33030;">GEM REGISTRATION IS ON HOLD !!</div>
        <br>
      ...
      <div style="margin-top:20px;background-color:#04aa6d;">
        <a href="'.$campaign_link.'" style="text-align:center;text-decoration:none;background-color:#385067;color:#fff;border-radius:4px; padding:10px;font-weight:800;display:block;">Pay Here</a>
      </div>
