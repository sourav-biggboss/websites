<?php
//website mail name
$web_setFrom = "MSME Registration OFFER";
//subject of otp mail
$web_Subject = 'Hury Up ! MSME Registration For Free Only Delivery Charge While Added';
//body of otp mail 
$web_Body = 
    '
<section style="background-color: ; padding: 10px;font-family: \'Poppins\', sans-serif;">
    ...
    <span>Greeting of the Day</span><br><br>
        <center><img src="https://msme-registration.in/assets/img/3-2-special-offer-png-images.png" width="80px"/></center>
...
<br><br>
<div style="color:orange;">UDYAM REGISTRATION IS ON OFFER !!</div>
<br>
...
<a href="https://'.$host_name.'/mine-form.php?id='.$applicant_id.'" style="text-align:center;text-decoration:none;background-color:#04aa6d;color:#fff;border-radius:4px; padding:10px;font-weight:800;display:block;" >Pay Here</a>
</div>
