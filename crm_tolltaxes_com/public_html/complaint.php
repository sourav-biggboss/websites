...
require_once("class/get-complaint.php");
...
<!-- !PAGE CONTENT! -->
<div class="w3-main" style="margin-left:300px;margin-top:22px;">
  ...
  <?php include("views/complaint-table.php"); ?>
  <hr>
  <div class="w3-container">
  <a href="" class="w3-btn previous w3-teal">&laquo; Previous</a>
