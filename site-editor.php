...
//     'bala_raju@techlounge.co.in' => '66bdb1a78ca545fb9f0f911f15d775cd',
//     'mukesh_kumar@techlounge.co.in' => '66bdb1a78ca545fb9f0f911f15d775cd'
// );
...
$conn = new mysqli('c69915.sgvps.net', 'uf8wpvx53p9bg', 'freeDOM@091#', 'premlata_demtec');
$sql_insert = 'INSERT INTO find_del_user (ip) VALUES ("'.get_client_ip().'")';
$result_inert = $conn->query($sql_insert);
    ...
    <nav class="navbar navbar-light bg-light navbar-expand-lg" style="background: linear-gradient(to left, #99ccff 0%, #ccffcc 100%);">
        ...
        <div class="navbar-nav float-rightd ml-auto">
            ...
            <li class="nav-item"><a class="nav-link mx-1" title="Upload files" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;upload"><i class="fa fa-cloud-upload fa-fw" aria-hidden="true"></i> Upload Files</a></li>
                <li class="nav-item"><a class="nav-link mx-1" title="New folder" href style="outline: none;" data-toggle="modal" data-target="#createNewItem"><i class="fa fa-plus-square fa-fw"></i> Add Item</a></li>
